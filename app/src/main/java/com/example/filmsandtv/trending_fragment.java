...
//        View v = inflater.inflate(R.layout.trending_fragment, container);
//        return v;
//    }
//
//    @Override
...
//        grid = view.findViewById(R.id.trending_grid);
//        fetchMovies(grid);
//    }
//
//    private void fetchMovies(RecyclerView grid) {
//        String url = "https://api.themoviedb.org/3/trending/all/week?api_key=216a1a11469ad220b5b12f0009090e70";
